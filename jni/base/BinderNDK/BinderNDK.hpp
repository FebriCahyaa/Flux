 ...
 */
/*
 * Taken unmodified from Encore Tweaks (https://github.com/Rem01Gaming/encore),
 * jni/base/BinderNDK. Loads libbinder_ndk at runtime so the daemon also runs on
 * builds where some NDK binder symbols are missing.
 */
